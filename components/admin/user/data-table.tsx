              ...
              <TableRow key={item.id}>
                ...
                <TableCell>
                  <Badge variant="outline">
                    {item.membership?.title ?? "No membership"}
                  </Badge>
                </TableCell>
                <TableCell>
                  {item.banned ? (
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem asChild>
                        <Link href={`/admin/users/${item.id}/update`}>
                          <FilePenIcon className="mr-2 h-4 w-4" /> Update
                        </Link>
                      </DropdownMenuItem>
                      {item.banned ? (
                        <DropdownMenuItem onClick={() => handleUnban(item.id)}>
                          <ShieldBanIcon className="mr-2 h-4 w-4" /> Unban
                        </DropdownMenuItem>
                      ) : (
                        <DropdownMenuItem
                          onClick={() => setBanModalUserId(item.id)}
                        >
                          <ShieldBanIcon className="mr-2 h-4 w-4" /> Ban
                        </DropdownMenuItem>
                      )}
                      <DropdownMenuSeparator />
                      <DropdownMenuItem
