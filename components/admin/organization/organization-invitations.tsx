...
const OrganizationInvitations = ({
  ...
  const [invitationToActOn, setInvitationToActOn] = useState<string | null>(
    null
  )
  ...
  const userInvitations = invitations.filter(
    invitation =>
      invitation.email === invitations.find(i => i.id === invitation.id)?.email
  )
              ...
              <TableCell>
                <div className="flex space-x-2">
                  <Button
                    ...
                    disabled={
                      isAccepting && invitationToActOn === invitation.id
                    }
                  >
                    {isAccepting && invitationToActOn === invitation.id
                      ? "Accepting..."
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will reject the invitation to join the
                          organization. You can always ask for another
                          invitation later.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                          onClick={() =>
                            invitationToActOn &&
                            handleRejectInvitation(invitationToActOn)
                          }
                          disabled={
