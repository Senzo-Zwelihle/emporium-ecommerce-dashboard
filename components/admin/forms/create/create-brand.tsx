...
const CreateBrandForm = () => {
  ...
  function onSubmit(values: BrandSchemaType) {
    startTransition(async () => {
      const { data: result, error } = await tryCatch(createBrandAction(values))
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                This is the public display name.This is what users will see
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Upload the brand image, supported formats include png,jpg and
                svg.
              </FormDescription>
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormMessage />
              <FormDescription>
                The will be displayed on the website.
              </FormDescription>
            </FormItem>
          )}
        />
