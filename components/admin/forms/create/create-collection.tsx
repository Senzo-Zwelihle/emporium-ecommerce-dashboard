...
import { createCollectionAction } from "@/server/actions/admin/collection"
...
const CreateCollectionForm = ({ categories }: CreateNewCollectionProps) => {
  ...
  const form = useForm<CollectionSchemaType>({
    ...
    defaultValues: {
      ...
      color: "#000000",
      image: "",
      status: "active" as CollectionSchemaType["status"]
    }
  })
