...
import { promotionSchema, PromotionSchemaType } from "@/schemas/admin/promotion"
import { updatePromotionAction } from "@/server/actions/admin/promotion"
  ...
  function onSubmit(values: PromotionSchemaType) {
    startTransition(async () => {
      const { data: result, error } = await tryCatch(
        updatePromotionAction(promotion.id, values)
      )
