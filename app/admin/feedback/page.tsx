...
import {
  reviewColumns,
  experienceColumns
} from "@/components/admin/feedback/columns"

import { fetchAllReviews, fetchAllExperiences } from "@/app/api/admin/feedback"

async function fetchData() {
  noStore()
  const [reviews, experiences] = await Promise.all([
    fetchAllReviews(),
    fetchAllExperiences()
  ])
        ...
        <Tabs defaultValue="reviews" className="w-full">
          <TabsList>
            ...
            <TabsTrigger value="experiences">
              User Experiences ({experiences.length})
            </TabsTrigger>
          </TabsList>
