...
import CreateSwatchForm from "@/components/admin/forms/create/create-swatch"
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <Button asChild size="sm" variant="outline">
                      <Link
                        href={`/admin/products/${productId}/swatches/${swatch.id}/update`}
                      >
                        Edit
                      </Link>
                    </Button>
                    <Button asChild size="sm" variant="destructive">
                      <Link
                        href={`/admin/products/${productId}/swatches/${swatch.id}/delete`}
                      >
                        Delete
                      </Link>
                    </Button>
