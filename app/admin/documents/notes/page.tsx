...
import { FilePenLineIcon } from "@/components/pqoqubbw/icons/file-pen-line"
import { fetchAllNotes } from "@/app/api/admin/note"
    ...
    return (
      ...
      >
        ...
        <Button>
          {" "}
          <PlusIcon />
          <Link href={"/admin/documents/notes/create"}>Create Note</Link>
        </Button>
      </Container>
    )
  }
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuItem>
                      <div className="flex w-full items-center justify-between">
                        <Link href={`/admin/documents/notes/${note.id}`}>
                          View
                        </Link>
                    ...
                    <DropdownMenuItem>
                      <div className="flex w-full items-center justify-between">
                        <Link href={`/admin/documents/notes/${note.id}/update`}>
                          Edit
                        </Link>
                    ...
                    <DropdownMenuItem variant="destructive">
                      <div className="flex w-full items-center justify-between">
                        <Link href={`/admin/documents/notes/${note.id}/delete`}>
                          Delete
                        </Link>
